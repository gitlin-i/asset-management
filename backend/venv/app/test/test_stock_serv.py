...
def test_stock_service():
    ...
    mapped_json = StockPriceResponseOfKorInvAPI(**overseas_test_stock_response)
    mapped_json2 = StockPriceResponseOfKorInvAPI(**domestic_test_stock_response)
    assert mapped_json.output.price == "1091.2600"
    assert mapped_json2.output.price == "128500"
